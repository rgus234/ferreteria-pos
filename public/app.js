...
function renderTopbarPOS() { const topbar = asegurarTopbarPOS(); if (!topbar) return; const notificaciones = notificacionesSistemaPOS(); const logoSistema = '<img src="nexo-pos-icon.jpg" alt="Nexo POS" class="nexo-pos-logo">'; topbar.innerHTML = '<div class="topbar-title-block"><span class="topbar-eyebrow">Ferreteria Olimpico POS</span><strong id="topbarTituloPOS">' + contextoTopbarPOS.titulo + '</strong><small id="topbarSubtituloPOS">' + contextoTopbarPOS.subtitulo + '</small></div><div class="topbar-actions"><button type="button" class="topbar-action" onclick="abrirRecordatorioPOS()" title="Nuevo recordatorio">' + iconoUISVG("plus") + '<span>Recordatorio</span></button><button type="button" id="btnNotificacionesPOS" class="topbar-bell" onclick="toggleNotificacionesPOS()" title="Notificaciones">' + iconoUISVG("bell") + '<span id="badgeNotificacionesPOS" class="notification-badge">' + notificaciones.length + '</span></button><div class="topbar-brand-pill nexo-brand-pill"><div class="topbar-logo nexo-topbar-logo">' + logoSistema + '</div><div><strong>Nexo POS</strong><span>Sistema comercial</span></div></div></div><div id="panelNotificacionesPOS" class="notificaciones-panel" aria-live="polite"></div>'; renderNotificacionesPOS(); }
