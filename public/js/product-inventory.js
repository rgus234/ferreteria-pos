...
// Puente hacia el editor de etiquetas (public/js/barcode-labels.js,
// pantalla "Codigos de barras") -- reemplaza a la vieja
// imprimirCodigosBarrasInventario(), que armaba una hoja fija de 3
// columnas sin lista propia, sin plantillas y sin poder generar
// codigo a productos que no tenian. Le pasa lo ya filtrado aqui como
// lista inicial, para no perder la comodidad de "ya tengo esto a la
// vista, imprime esto".
function abrirCodigosBarrasDesdeInventario() {
 if (typeof mostrarCodigosBarras === "function") {
 mostrarCodigosBarras({ productosIniciales: productosInventarioFiltrados() });
 }
}
